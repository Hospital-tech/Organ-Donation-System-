...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
	...
	<title>Edit Profile - Blood and Organ Donation Management System</title>
    ...
    <div class="edit-form box-left clearfix">
      <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST">
        ...
        <div class="form-group">
          ...
          <?php 
            $query = "SELECT dob FROM students WHERE id = '".$_SESSION['userid']."'";
            $result = mysqli_query($con, $query);
            $row = mysqli_fetch_row($result);
        ...
        <div class="form-group">
          ...
          <?php 
            $query = "SELECT course FROM students WHERE id = '".$_SESSION['userid']."'";
            $result = mysqli_query($con, $query);
            $row = mysqli_fetch_row($result);
        ...
        <div class="form-group">
          ...
          <?php 
            $query = "SELECT yrlevel FROM students WHERE id = '".$_SESSION['userid']."'";
            $result = mysqli_query($con, $query);
            $row = mysqli_fetch_row($result);
