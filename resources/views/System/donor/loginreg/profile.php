    ...
    <div class="profile-box box-left">
      ...
      <?php
        ...
        if($result = mysqli_query($con, $query)) {
          ...
          echo "<div class='info'><strong>NID No:</strong> <span>".$row['studentno']."</span></div>";
          echo "<div class='info'><strong> Name:</strong> <span>".$row['lastname'].", ".$row['firstname']."</span></div>";
          echo "<div class='info'><strong>Blood Group:</strong> <span>".$row['course']."</span></div>";
          echo "<div class='info'><strong>Date of Birth:</strong> <span>".$row['dob']."</span></div>";
          echo "<div class='info'><strong>Gender:</strong> <span>".$row['yrlevel']."</span></div>";
          echo "<div class='info'><strong>Address:</strong> <span>".$row['address']."</span></div>";
          echo "<div class='info'><strong>ZIP:</strong> <span>".$row['zip']."</span></div>";
      ...
      <div class="options">
        ...
        <a class="btn btn-success" href="../index.php">Visit Homepage</a>
      </div>
