...
$status="0";
$sql = "UPDATE hospitalblooddonars SET Status=:status WHERE  id=:eid";
...
$sql = "UPDATE hospitalblooddonars SET Status=:status WHERE  id=:aeid";
$query = $dbh->prepare($sql);
$query -> bindParam(':status',$status, PDO::PARAM_STR);
...
if(isset($_REQUEST['del']))
	{
$did=intval($_GET['del']);
$sql = "delete from hospitalblooddonars WHERE  id=:did";
$query = $dbh->prepare($sql);
...
<?php $sql = "SELECT * from  hospitalblooddonars ";
$query = $dbh -> prepare($sql);
$query->execute();
