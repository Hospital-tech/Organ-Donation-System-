...
<head>
	...
	<title> | Available Blood Group</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title"> Available Blood Group</h2>
...
<?php 
$sql ="SELECT id from hospitalbloodgroup ";
									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-success text-light">
												<div class="stat-panel text-center">
												<?php 
$sql1 ="SELECT id from hospitalblooddonars ";
