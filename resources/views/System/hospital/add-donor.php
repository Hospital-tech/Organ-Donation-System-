...
$status=1;
$sql="INSERT INTO  hospitalorgandonars(FullName,MobileNumber,EmailId,Age,Gender,OrganType,HospitalName,Address,Message,status) VALUES(:fullname,:mobile,:email,:age,:gender,:organtype,:hospitalname,:address,:message,:status)";
...
<option value="">Select</option>
<?php $sql = "SELECT * from  hospitalorgantype ";
$query = $dbh -> prepare($sql);
$query->execute();
