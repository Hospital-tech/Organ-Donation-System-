...
(4, 'IF YOU ARE A ORGAN DONOR
YOU ARE A HERO', 'blog', '<span style="color: rgb(0, 0, 0); font-family: &quot;Open Sans&quot;, Arial, sans-serif; text-align: justify;">Organ donation takes healthy organs and tissues from one person for transplantation into another. Experts say that the organs from one donor can save or help as many as 50 people. Organs you can donate include: Internal organs: Kidneys, heart, liver, pancreas, intestines, lungs Skin Bone and bone marrow Cornea Most organ and tissue donations occur after the donor has died. But some organs and tissues can be donated while the donor is alive. People of all ages and background can be organ donors. If you are under age 18, your parent or guardian must give you permission to become a donor. If you are 18 or older you can show you want to be a donor by signing a donor card. You should also let your family know your wishes.
</span>');
...
CREATE TABLE IF NOT EXISTS `hospitalorgantype` (
  `id` int(11) NOT NULL,
  `OrganType` varchar(20) DEFAULT NULL,
  `HospitalName` varchar(100) DEFAULT NULL,
  `PostingDate` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
...
ALTER TABLE `hospitalorgantype`
  ...
  CREATE TABLE IF NOT EXISTS `hospitalorgandonars` (
  `id` int(11) NOT NULL,
  `FullName` varchar(100) DEFAULT NULL,
  `MobileNumber` char(11) DEFAULT NULL,
  `EmailId` varchar(100) DEFAULT NULL,
...
ALTER TABLE `hospitalorgandonars`
  ADD PRIMARY KEY (`id`);
...
CREATE TABLE IF NOT EXISTS `hospitalbloodgroup` (
  `id` int(11) NOT NULL,
  `BloodGroup` varchar(20) DEFAULT NULL,
  `PostingDate` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=latin1;

ALTER TABLE `hospitalbloodgroup`
  ADD PRIMARY KEY (`id`);
  ...
  CREATE TABLE IF NOT EXISTS `hospitalblooddonars` (
  `id` int(11) NOT NULL,
  `FullName` varchar(100) DEFAULT NULL,
  `MobileNumber` char(11) DEFAULT NULL,
  `EmailId` varchar(100) DEFAULT NULL,
...
ALTER TABLE `hospitalblooddonars`
  ADD PRIMARY KEY (`id`);
