    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-4 mb-4">
                <div class="card">
                    <h4 class="card-header">The need for Organ</h4>
                   
                        <p class="card-text" style="padding-left:2%">Donation is the giving of an organ and tissue to help someone that needs a transplant. Transplants can save or transform the life of a person. One organ and tissue donor can help transform the lives of more than 10 people. </p>
                </div>
            </div>
            <div class="col-lg-4 mb-4">
                <div class="card">
            ...
            <div class="col-lg-4 mb-4">
                <div class="card">
                    <h4 class="card-header">Who you could Help</h4>
                        ...
                        <p class="card-text" style="padding-left:2%">Regular blood donation is linked to lower blood pressure and a lower risk for heart attacks. “It definitely helps to reduce cardiovascular risk factors,” says DeSimone. </p>
                </div>
            </div>
        </div>
        <!-- /.row -->
